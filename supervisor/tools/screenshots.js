...
const { resolveChrome, resolveBase, waitForHealth, FAKE_CONTAINERS, FAKE_UPTIME, FAKE_IMAGE_STATUS } = require('./lib/harness');
const EXE = resolveChrome();
const BASE = resolveBase({ iKnow: args.iKnow });
